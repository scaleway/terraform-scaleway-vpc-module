...
This module can be used to deploy a VPC with various resources. Common deployment examples can be found in [examples/]().
...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------- | -------------- | -------- |
| reverse_dns_zone                         |                                                                                                                                                                                      | `bool`         | false          | no       |
| gateway_reverse_dns                      |                                                                                                                                                                                      | `bool`         | false          | no       |
...
| zone                                     | Zone in which resources should be created                                                                                                                                            | `string`       | null           | **yes**  |
